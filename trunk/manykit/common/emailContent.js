module.exports = {
    ...
    activeEmail(mail, username, cdkey, headerReferer,callback) {
        ...
        <a href="http://www.manykit.com/res/active?cdkey=${username}${cdkey}&a=${headerReferer}">http://www.manykit.com/res/active?cdkey=${username}${cdkey}&a=${headerReferer}</a>
        ...
        如果你有任何注册相关的问题，欢迎联系我们。</font></div><div><font face="lucida Grande, Verdana, Microsoft YaHei"><br></font></div><div><font face="lucida Grande, Verdana, Microsoft YaHei">官网：<a href="http://www.manykit.com">www.manykit.com</a></font></div>
        `;
        callback(mailHtml);
    },
    //验证码邮件
    codeEmail(code, callback) {
        ...
        如果你有任何账号相关的问题，欢迎联系我们。</font></div><div><font face="lucida Grande, Verdana, Microsoft YaHei"><br></font></div><div><font face="lucida Grande, Verdana, Microsoft YaHei">官网：<a href="http://www.manykit.com">www.manykit.com</a></font></div>`;
        callback(mailHtml);
    }
}