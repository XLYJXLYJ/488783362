...
app.use("/codeplay", express.static("webs/codeplay", { etag: false, dotfiles: "allow", index: "index.html" }));
app.use("/model", express.static("webs/res", { etag: false, dotfiles: "allow", index: "index.html" }));
...
//第三方用户登录
app.use(api.user.thirdlogin, func.res.thirdlogin);
//退出
